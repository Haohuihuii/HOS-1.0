...
print:
    ...
    .write:
        ...
        jz .done
        int 0x10 
        ;ES 被设置成了 VGA 显存段，但当前 print 函数实际上通过 BIOS INT 10h 输出，没有使用 ES。
        inc si
        jmp .write
    .done:
        pop ax
...
protect_mode:
    cli ; close interrupt
    mov si, entry_protect_mode_message
    call print
...
; messages
loader_message:
    db "Hello, this is loader", 10, 13, 0  ; 10: /n 13: /r
